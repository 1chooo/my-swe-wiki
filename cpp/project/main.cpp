...
void opening()
{
    wcout << "         o   o   o   o     o   o   o   o       o          o    o   o   o   o        o  o   o   o   " << endl;
    Sleep(200);
    SetColor(11);
    wcout << "         o           o     o           o       o        o      o                    o          o   " << endl;
    Sleep(200);
    SetColor(12);
    wcout << "         o           o     o           o       o       o       o                    o          o   " << endl;
    Sleep(200);
    ...
    Sleep(200);
    SetColor(15);
    wcout << "         o   o   o   o     o           o       o o             o   o   o   o        o  o   o   o   " << endl;
    Sleep(200);
    SetColor(11);
    wcout << "         o                 o           o       o o             o                    o  o           " << endl;
    Sleep(200);
    SetColor(12);
    wcout << "         o                 o           o       o   o           o                    o    o         " << endl;
    Sleep(200);
    ...
    Sleep(200);
    SetColor(12);
    wcout << "         o                 o   o   o   o       o           o   o   o   o   o        o            o " << endl;
    Sleep(200);
    SetColor(13);
    SetColor();
